                            ...
                            <div className="detail-product">
                                ...
                                <div className="css-30 css-1002">
                                    ...
                                    <div className="css-35">
                                        <div className="css-36"> <a href="../Trangsanpham/giohang.html" className="css-39">Mua ngay</a> </div>
                                        <div className="css-37"> <a href="../Trangsanpham/giohang.html" className="css-39 css-40">Thêm vào giỏ hàng</a></div>
                                    </div>
                                </div>
